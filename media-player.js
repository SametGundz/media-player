...
function togglePlayPause() {
   ...
   if (mediaPlayer.paused || mediaPlayer.ended) {
      btn.title = 'pause';
      btn.innerHTML = '<img src=\"pngs/pause.png\" width=\"100%\">';
      btn.className = 'pause';
      mediaPlayer.play();
   }
   else {
      btn.title = 'play';
      btn.innerHTML = '<img src=\"pngs/play.png\" width=\"100%\">';
      btn.className = 'play';
      mediaPlayer.pause();
   }
}
...
function timeUpdate() {
   ...
   mediaPlayer.currentTime = parseFloat(mediaPlayer.currentTime).toFixed(0.5);
}
...
function toggleMute() {
   ...
   if (mediaPlayer.muted) {
      ...
      btn.innerHTML = '<img src=\"pngs/mute.png\" width=\"100%\">';
   }
   else {
      changeButtonType(btn, 'Unmute');
      mediaPlayer.muted = true;
      btn.innerHTML = '<img src=\"pngs/unmute.png\" width=\"100%\">';
   }
}
